...
allowed-tools: Bash(node /home/amol/code/nori/nori-integrations/.worktrees/slack/.claude/skills/nori-sync-docs/script.js:*)
---
...
```bash
node /home/amol/code/nori/nori-integrations/.worktrees/slack/.claude/skills/nori-sync-docs/script.js
```
